defmodule MLLPartyWeb.Plug.Heartbeat do
  ...
  The following options can be used when calling `plug HeartbeatPlug`.
    ...
    * `:path` - a string expressing the path on which `HeartbeatPlug` will be mounted to
  ...
  ## Examples
      ...
      defmodule MyServer do
        use Plug.Builder
        plug MLLPartyWeb.Plug.Heartbeat
  ...
  Using a custom heartbeat path is easy:
      ...
      defmodule MyServer do
        use Plug.Builder
        plug MLLPartyWeb.Plug.Heartbeat, path: "/heartbeat"
